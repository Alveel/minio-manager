...
try:
    ...
    if "pytest" in sys.modules or any("pytest" in arg for arg in sys.argv):
        ...
        class TestSettings(BaseSettings):
            ...
            # default_lifecycle_policy_file: str | None = None  # Consider removing if not needed for tests
            # default_bucket_policy_file: str | None = None  # Consider removing if not needed for tests
